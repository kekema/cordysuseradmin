...
public abstract class UIOrgUserBasicBase extends com.cordys.cpc.bsf.busobject.CustomBusObject
{
    ...
    public static ClassInfo _getClassInfo()//NOPMD framework ensures this is thread safe
    {
        ...
        {
            s_classInfo = newClassInfo(UIOrgUserBasic.class);
    ...
    public UIOrgUserBasicBase(BusObjectConfig config)
    {
        super(config);
    }
